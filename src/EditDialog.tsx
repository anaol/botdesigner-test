...
export function EditDialog(props: PropsWithChildren<any>): ReactElement {
    ...
    useEffect(() => {
        ...
        setFileType(props.editData.data.fileType);
        setParent(props.editData.parent);
        setDroppable(props.editData.droppable);

        return undefined;
    }, [props.editData.droppable, props.editData.data.fileType, props.editData.parent, props.editData.text]);
